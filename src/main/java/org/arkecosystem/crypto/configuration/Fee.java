...
public class Fee {
    ...
    static {
        ...
        coreFees.put(
                TransactionType.SECOND_SIGNATURE_REGISTRATION.getValue(),
                Fees.SECOND_SIGNATURE_REGISTRATION.getValue());
        coreFees.put(
                TransactionType.DELEGATE_REGISTRATION.getValue(),
                Fees.DELEGATE_REGISTRATION.getValue());
        coreFees.put(TransactionType.VOTE.getValue(), Fees.VOTE.getValue());
        coreFees.put(
                TransactionType.MULTI_SIGNATURE_REGISTRATION.getValue(),
        ...
        coreFees.put(
                TransactionType.DELEGATE_RESIGNATION.getValue(),
