...
public class MultiSignatureRegistrationTest {
    ...
    void build() {
        ...
        Transaction actualV2 = new MultiSignatureRegistration()
            .min(2)
            .lifetime(255)
            .keysgroup(Arrays.asList(
                "03a02b9d5fdd1307c2ee4652ba54d492d1fd11a7d1bb3f3a44c4a05e79f19de933",
    ...
    void buildSecondSignature() {
        ...
        Transaction actual2 = new MultiSignatureRegistration()
            .min(2)
            .lifetime(255)
            .keysgroup(Arrays.asList(
                "03a02b9d5fdd1307c2ee4652ba54d492d1fd11a7d1bb3f3a44c4a05e79f19de933",
        ...
        assertTrue(actual2.secondVerify("03699e966b2525f9088a6941d8d94f7869964a000efe65783d78ac82e1199fe609"));
    }
