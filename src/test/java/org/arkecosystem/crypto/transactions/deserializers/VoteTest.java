...
public class VoteTest {
    ...
    @Test
    void passphrase() {
        HashMap<String, Object> fixture = FixtureLoader.load("transactions/vote/passphrase");
        ...
        assertEquals((List<String>)(asset.get("votes")), actual.asset.votes);
    ...
    void secondPassphrase() {
        HashMap<String, Object> fixture = FixtureLoader.load("transactions/vote/second-passphrase");
        LinkedTreeMap<String, Object> data = (LinkedTreeMap<String, Object>) fixture.get("data");
