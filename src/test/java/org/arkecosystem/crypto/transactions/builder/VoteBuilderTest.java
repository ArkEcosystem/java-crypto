...
class VoteBuilderTest {
    ...
    void buildVote() {
        ...
        assertEquals(actualVotes, Arrays.asList("+034151a3ec46b5670a682b0a63394f863587d1bc97483b1b6c70eb58e7f0aed192"));
    }
    ...
    void buildUnvote() {
        Transaction actual = new VoteBuilder()
            .addVote("-034151a3ec46b5670a682b0a63394f863587d1bc97483b1b6c70eb58e7f0aed193")
            .version(2)
            .nonce(3)
            .sign("this is a top secret passphrase")
            .transaction;
        ...
        assertEquals(actualVotes, Arrays.asList("-034151a3ec46b5670a682b0a63394f863587d1bc97483b1b6c70eb58e7f0aed193"));
    }
