...
public class HtlcLockTest {
    ...
    void passphrase() {
        ...
        LinkedTreeMap<String, Object> assetExpiration = (LinkedTreeMap<String, Object>) ((LinkedTreeMap<String, Object>) asset.get("expiration"));
        assertEquals(((Double) assetExpiration.get("type")).intValue(), actual.asset.htlcLockAsset.expiration.type.getValue());
        assertEquals(((Double) assetExpiration.get("value")).intValue(), actual.asset.htlcLockAsset.expiration.value);
